...
ALGORITHMS = ['RS256']
API_AUDIENCE = 'CapstoneUdacityAPI'   # unique identifier of API
...
def verify_decode_jwt(token):
    # Auth0 exposes a JWKS endpoint for each tenant,
    # which is found at https://YOUR_DOMAIN/.well-known/jwks.json
